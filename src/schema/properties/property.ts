...
export const PropertiesOutput = z.object({
  properties: z.array(
    z.object({
      id: z.string(),
      createdAt: z.number(),
      ...
      bedrooms: z.number(),
      bathrooms: z.number(),
      kitchen: z.unknown().nullable(),
      gym: z.unknown().nullable(),
      patio: z.unknown().nullable(),
      pool: z.unknown().nullable(),
      hotTub: z.unknown().nullable(),
      parking: z.unknown().nullable(),
      ...
      offeringName: z.unknown().nullable(),
      offerDateStart: z.number(),
      numberOfBricks: z.number(),
      minCommitmentBricks: z.unknown().nullable(),
      maxCommitmentBricks: z.unknown().nullable(),
      type: z.string(),
      status: z.string(),
      ...
      brickPrice: z.number(),
      currentValuePercent: z.number(),
      totalDividendsReceivedPercent: z.number(),
      totalPercent: z.number(),
      totalValue: z.unknown().nullable(),
      lastDividendsPaidDate: z.unknown().nullable(),
      lastDividendsPerBrick: z.unknown().nullable(),
      publishStatus: z.string(),
      purchasedDate: z.number(),
      ...
      propertyBrickPrices: z.array(z.object({ value: z.number(), createdAt: z.string() })),
      propertyDividendsPayed: z.unknown().nullable(),
      bricksFunded: z.number(),
      investors: z.number(),
      dividendsDate: z.number(),
      customerDividendsYield: z.unknown().nullable(),
      isFunded: z.boolean(),
    })
  ),
  cursor: z.number(),
